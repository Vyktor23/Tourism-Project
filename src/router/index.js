...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/explore/:municipioSlug/platos/:platoSlug', name: 'PlatoDetail', component: PlatoDetail },
    { path: '/explore/:municipioSlug/eventos/:eventoId', name: 'EventoDetail', component: EventoDetail },
